...
import 'asesores_model.dart';
export 'asesores_model.dart';

class AsesoresWidget extends StatefulWidget {
  const AsesoresWidget({Key? key}) : super(key: key);

  @override
  _AsesoresWidgetState createState() => _AsesoresWidgetState();
}

class _AsesoresWidgetState extends State<AsesoresWidget> {
  late AsesoresModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AsesoresModel());
  }
                  ...
                  children: [
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          context.pushNamed('asesor_miguel');
                        },
                        child: Container(
                          width: 100.0,
                          height: 72.0,
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed('asesor_angel');
                        },
                        child: Container(
                          width: 100.0,
                          height: 72.0,
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed('asesor_alexis');
                        },
                        child: Container(
                          width: 100.0,
                          height: 72.0,

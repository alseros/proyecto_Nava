...
import 'asesores2_model.dart';
export 'asesores2_model.dart';

class Asesores2Widget extends StatefulWidget {
  const Asesores2Widget({Key? key}) : super(key: key);

  @override
  _Asesores2WidgetState createState() => _Asesores2WidgetState();
}

class _Asesores2WidgetState extends State<Asesores2Widget> {
  late Asesores2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Asesores2Model());
  }
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'a.20308051280541@cbtis128.edu.mx',
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium,
                                        ),
                                      ],
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'a.20308051280540@cbtis128.edu.mx',
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium,
                                        ),
                                      ],
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'a.20308051280539@cbtis128.edu.mx',
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium,
                                        ),
                                      ],
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'a.20308051280538@cbtis128.edu.mx',
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium,
                                        ),
                                      ],
